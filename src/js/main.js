...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  let collapsed = /*html*/ `
    ...
    <img src="./src/img/pages/movie-details/movies/alt-gik-godt-2021/scene-01@3x.jpg" alt="Foto fra filmen 'Alt gik godt'">
    <a id="description__read-more" href="javascript:void(0)" onclick="expandDescription()"></a>
  `;
  let expanded = /*html*/ `
    <p>Emmanuèle er romanforfatter og har succes både professionelt og privat. Da hendes far, André på 85 år, får et hjertetilfælde, skynder Emmanuelle sig til hospitalet. Syg og delvist paralyseret beder André sin datter om at gøre en ende på hans liv.</p>
    <img src="./src/img/pages/movie-details/movies/alt-gik-godt-2021/scene-01@3x.jpg" alt="Foto af scene fra filmen 'Alt gik godt'">
    ...
    <img src="./src/img/pages/movie-details/movies/alt-gik-godt-2021/scene-02@3x.jpg" alt="Foto af scene fra filmen 'Alt gik godt'">
    <p>François Ozon har lavet et stærkt og rørende drama, som var nomineret til Den gyldne palme ved Cannes Film Festival.</p>
    <a id="description__read-less" href="javascript:void(0)" onclick="collapseDescription()"></a>
  `;
  let description = {
    collapsed,
    expanded,
  ...
  const movie1 = CrudService.createMovie('Trøffeljægerne fra Piemonte', 2021, 'src/img/movies/troeffeljaegerne-fra-piemonte-2021/poster/poster-1@3x.jpg', null, null, null, ['Dokumentar', 'Jagt', 'Feel-Good'], null, null, null, null, null, true);
